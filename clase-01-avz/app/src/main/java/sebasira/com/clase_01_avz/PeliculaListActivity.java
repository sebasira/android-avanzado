...
import sebasira.com.clase_01_avz.dummy.DummyContent;
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(PeliculaDetailFragment.ARG_ITEM_ID, holder.mItem.id);
                        ...
                        intent.putExtra(PeliculaDetailFragment.ARG_ITEM_ID, holder.mItem.id);
